...
if ($_FILES["avatar"]["error"] != UPLOAD_ERR_NO_FILE) {
    if ($_FILES["avatar"]["size"] > 5000000) {
        $_SESSION["mensagens"] = array_merge($_SESSION["mensagens"], array("Arquivo do avatar não pode exceder 5MB.<br>" => "a"));
        header("Location: " . filter_input(INPUT_SERVER, 'HTTP_REFERER'));
        return;
    }
    ...
    $path_file_foto = "$imageDir/$avatarFilename";
    ...
    if (!file_exists($path_file_foto)) {
        ...
        copy("../resources/images/$avatarFilename", $path_file_foto);
    }
}
