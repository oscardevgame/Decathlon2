...
//variaveis para manipulacao do tracker de gravação
var playerposicaoarray = new Array();
var posxyp1 =0;
var gravou = 0;
//------------------------------------

//variaveis para manipulacao da leitura de tracker para o P2 virtual
...
//--------------------------------------------------------------------------------------------------------------------
    ...
    //ESTA FUN��O TESTA SE É FIM DO JOGO E CRIA OBSTACULOS ALEATORIAMENTE ENQUANTO A CORRIDA NAO TIVER ACABADO
    $.playground().registerCallback(function() {
        if (!gameOver) {
            if (Math.random() < 0.4) {
